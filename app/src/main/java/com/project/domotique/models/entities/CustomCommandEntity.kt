...
data class CustomCommandEntity (
    ...
    enum class CustomCommand(val label: String)
    {
        ...
        /* Door Command */
        TURN_ON_ALL_DOOR("Allumer toutes les portes du 1er étage"),

        /* Rolling Shutter Commands */
        OPEN_ALL_ROLLING_SHUTTER("Ouvrir toutes les volets de la maison"),
        CLOSE_ALL_ROLLING_SHUTTER("Fermer toutes les volets de la maison"),
        OPEN_ROLLING_SHUTTER_IN_FIRST_FLOOR("Ouvrir le volets du rez de chaussée"),
        CLOSE_ROLLING_SHUTTER_IN_FIRST_FLOOR("Fermer le volets du rez de chaussée"),
        OPEN_ROLLING_SHUTTER_IN_SECOND_FLOOR("Ouvrir le volets du 1er étage"),
        CLOSE_ROLLING_SHUTTER_IN_SECOND_FLOOR("Fermer le volets du 1er étage"),
