...
class CongratulationDialog(
    val title: String,
    val description: String? = "Vous pouvez dès à présent à manager vos maisons et passer des commandes à vos appareils !",
    context: Context,
    val onConfirm: () -> Unit)
    : Dialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dialog_congratulation_popup)
