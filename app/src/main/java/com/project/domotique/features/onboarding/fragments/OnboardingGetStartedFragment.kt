...
import com.project.domotique.features.onboarding.OnboardingNavigationListener
...
class OnboardingGetStartedFragment(): Fragment() {
    ...
    {
        return inflater.inflate(R.layout.fragment_onboarding_activity_get_started, container, false)
    }
