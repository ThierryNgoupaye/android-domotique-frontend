...
class Api {
    ...
    inline fun <reified T>get(path: String, crossinline onSuccess: (Int, T?) -> Unit, securityToken: String? = null)
    {
        request<T, Unit>(path, "GET", onSuccess, null, securityToken);
    }

    inline fun <reified K, reified T>post(path: String, data: K, crossinline onSuccess: (Int, T?) -> Unit, securityToken: String? = null)
    {
        request<T, K>(path, "POST", onSuccess, data, securityToken);
    }

    inline fun <reified K>post(path: String, data: K, crossinline onSuccess: (Int) -> Unit, securityToken: String? = null)
    {
        request<K>(path, "POST", onSuccess, data, securityToken);
    }

    inline fun <reified K>put(path: String, data: K, crossinline onSuccess: (Int) -> Unit, securityToken: String? = null)
    {
        request<K>(path, "PUT", onSuccess, data, securityToken);
    }

    inline fun delete(path: String, crossinline onSuccess: (Int) -> Unit, securityToken: String? = null)
    {
        request<Unit>(path, "DELETE", onSuccess, null, securityToken);
    }

    inline fun <reified K> delete(path: String, data: K, crossinline onSuccess: (Int) -> Unit, securityToken: String? = null)
    {
